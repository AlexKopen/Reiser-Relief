...
export class DonateComponent implements OnInit {
    ...
    buy() {
        this.donorAddress = new DonationAddress(this.addressForm.value.city, this.addressForm.value.state,
            this.addressForm.value.addressLine1, this.addressForm.value.addressLine2,
